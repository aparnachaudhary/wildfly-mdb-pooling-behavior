...
/**
 * Definition of the two JMS destinations used by the quickstart (one queue and one topic).
 */
...
public class HelloWorldMDBServletClient extends HttpServlet {
    ...
    private static final int MSG_COUNT = 21;
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        out.write(
                "<h1>Quickstart: Example demonstrates the use of <strong>JMS 2.0</strong> and <strong>EJB 3.2 Message-Driven Bean</strong> in WildFly 8.</h1>");
        try {
